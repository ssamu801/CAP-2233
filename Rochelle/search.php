                ...
                if (resp) {
                    ...
                    if (resp.length > 0) {
                        ...
                        resp.forEach(item => {
                            ...
                            li.find('.name').attr('href', 'index.php?page=information_resources/view_media&id='+item.file_id+'&type='+item.type);
                            li.find('.comments').text(item.comments);
                            
                            if (item.media_tags && item.media_tags.length > 0) {
                                item.media_tags.forEach(tag => {

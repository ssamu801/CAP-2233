...
if(isset($_SESSION['isCounselor'])){
    unset($_SESSION['isCounselor']);
}

$_SESSION['isCounselor'] = "1";


$_SESSION['counselorID'] = $_SESSION['login_id'];
  ...
  <!--  <form method="post"  action="index.php?page=appointments/addeventtodb" class="form" onsubmit="return validateForm()"> -->
        ...
        ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" value='Follow Up Consultation - <?php echo $row["name"]; ?>' readonly >
            </div>
            <div class="form-group">
                <label>Session Description</label>
                <input type="text" name="description" class="form-control" value='Follow up consultation with student named <?php echo $row["name"]; ?>, ID<?php echo $id; ?>' readonly ></input>
            </div>
        <?php endwhile; ?>
        <?php endif; ?>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <?php if (isset($counselorID)) { echo "checked"?> >  <?php } ?>
        </div>
